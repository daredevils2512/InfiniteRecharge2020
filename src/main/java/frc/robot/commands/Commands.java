...
public final class Commands {
  ...
  public static Command autoFeedShooter(IQueue queue, double queueSpeed, IntSupplier magazinePowerCellCountSupplier, BooleanSupplier shooterAtSetpointSupplier) {
    return new AutoFeedShooter(queue, queueSpeed, magazinePowerCellCountSupplier, shooterAtSetpointSupplier);
  }
  ...
  public static Command runShooter(IShooter shooter, DoubleSupplier speedSupplier) {
    ...
    return new RunCommand(() -> shooter.setShooterPercentOutput(speedSupplier.getAsDouble()), shooter);
  ...
  public static Command setShooterVelocity(IShooter shooter, DoubleSupplier velocitySupplier) {
    return new RunCommand(() -> shooter.setShooterVelocity(velocitySupplier.getAsDouble()), shooter);
  }

  public static Command setShooterAngle(IShooter shooter, DoubleSupplier angleSupplier) {
    return new RunCommand(() -> shooter.setHoodAngle(angleSupplier.getAsDouble()), shooter);
  }

  public static Command stopShooter(IShooter shooter) {
    return new InstantCommand(() -> shooter.setShooterVelocity(0), shooter);
  }
