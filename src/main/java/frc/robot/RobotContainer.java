...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    m_joystickMap.put(JoystickCommand.MANUAL_RUN_INTAKE, () -> m_controlBoard.xbox.getLeftTrigger());
    m_joystickMap.put(JoystickCommand.MANUAL_RUN_INTAKE_REVERSE, () -> m_controlBoard.xbox.getRightTrigger());
