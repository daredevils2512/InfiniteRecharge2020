...
public class Queue extends SubsystemBase {
   ...
   */
  public Queue() {
    m_networkTable = NetworkTableInstance.getDefault().getTable(getTableName());
  ...
  public void periodic() {
    m_networkTable.getEntry("Run speed").setNumber(m_runMotor.getMotorOutputPercent());
    m_networkTable.getEntry("Is closed").setBoolean(getIsClosed());
