...
public class MagazinePowerCellCounter {
  ...
  private static IQueue m_queue;
  private static IMagazine m_magazine;

  public MagazinePowerCellCounter(IQueue queue, IMagazine magazine) {
  ...
  public static int getCount() {
    int count = m_magazine.getCount() + m_queue.getCount();
